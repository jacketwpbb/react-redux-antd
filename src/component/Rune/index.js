...
const Rune =({runeList})=>{
	...
	const runes = runeList.map(({ runes_id_ },idx) =>{
		...
		return (
			...
			>
				<img
					src={`http://lol.qq.com/act/a20170926preseason/img/runeBuilder/runes/108x108/${runes_id_}.png`}
					alt={runes_id_}
				/>
	...
	rune2.push(
		<li className={`rune-image ${getTreeClassName(
